...
long min_base_val[40] =           {   0,     0,      0,      0,    0,    0,  -1450,   -840,     0,    0,  -500,    0,  -700,     0,     0, -900,     0,    0,    400,   -100};
long max_base_val[40] =           { 400,  2000,   1000,      0,  500,    0,      0,   1000,  1450,    0,     0,    0,     0,     0,     0,  -400,   300,    0,  1000,      0};
long acceleration_val[40] =       {   4,     4,     10,      0,   10,    0,    -11,     10,    11,    0,   -10,    0,    -6,     0,     0,    -6,    15,    0,      6,     4};
long deacceleration_val[40] =     {   0,   -14,    -10,      0,   -2,    0,     10,    -10,   -10,    0,     2,    0,     0,     0,     0,     6,     0,    0,     -6,    -4};
int dis_2_slow[40] =              {   0, 15000,   6000,      0,    0,    0,   4000,   6000,  6000,    0,     0,    0,  3000,     0,     0, 16000,     0,    0,  16000,     0};
int time_2_slow[40] =             {   0,  2900,   1300,      0,  500,    0,   1000,   1500,  1000,    0,   500,    0,  1000,     0,     0,  1800,     0,    0,   2000,     0};

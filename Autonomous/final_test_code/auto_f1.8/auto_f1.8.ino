...
int time_2_slow[40] =             {   0,  2900,   1300,      0,  600,    0,   1000,   1200,  1000,    0,   600,    0,  1000,     0,     0,  2000,   600,    0,   2000,     0};
...
int time_cnt = 0;
///////////////////////////// Distances /////////////////////////////////////
int TZ1_dis_2_move = 2100, TZ2_dis_2_move = 1400, TZ3_dis_2_move = -4500, dis_margin =300; 

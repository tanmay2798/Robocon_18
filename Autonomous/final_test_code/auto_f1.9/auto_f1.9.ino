...
long min_base_val[40] =           {   0,     0,      0,      0,    0, -850,  -1450,   -840,     0,    0,  -600,    0,  -700,     0,     0, -1500,     0,    0,    400,   500};
...
int time_2_slow[40] =             {   0,  2900,   1300,      0,  600,    0,   1000,   1200,  1000,    0,   600,    0,  1000,     0,     0,  2300,   600,    0,   2300,     0};
...
int time_cnt = 0;
///////////////////////////// Distances /////////////////////////////////////
int TZ1_dis_2_move = 2400, TZ2_dis_2_move = 1400, TZ3_dis_2_move = -4500, dis_margin =300; 
  ...
  else if (state == 16)
  {
     ...
     else if (absolute(analogRead(LSA_0) - tz3_align_val) > lsa_margin)
    {
      ...
      while(absolute(analogRead(LSA_0) - tz3_align_val) > lsa_margin && millis() - time_stamp < 5000){
        ...
        pLSA_0_val = LSA_0_val;
        lsa_control = (tz3_align_val - LSA_0_val)/3;
        delay(1);

...
int sol_pin_r = 28, mag_pin_r = 26, ls_sol_r = 29, ls_mag_r = 27;   // TZ3
...
/////////////// Sabertooth //////////////////////////////
Sabertooth golden_rack(Serial3);
...
/////////////////////////// Ultrasonic //////////////////
float duration, cm;
int US_manual = 42, US_manual_reverse_trig = A4 , US_manual_reverse_echo = 41, US_ball_detect = 46;
int manual_dis_min = 5, manual_dis_max = 100, manual_reverse_dis_min = 20, manual_reverse_dis_max = 70, ball_dis_min = 7, ball_dis_max = 18;

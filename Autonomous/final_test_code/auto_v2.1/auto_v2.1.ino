...
int time_2_slow[17] =             {   0,  3500,   1000,      0,    0,    0,    1000,  1500,  1000,   0,    0,    0,  1200,     0,     0,  2300,     0};
...
int manual_dis_min = 5, manual_dis_max = 100, manual_reverse_dis_min_1 = 1, manual_reverse_dis_max_1 = 50, ball_dis_min = 7, ball_dis_max = 24;
...
//    if ((lin_diff > 30) || (ang_diff > 30))
//    {
      state_time_cnt = millis();
      if (debug_enable){
        Serial.println("Aligning Bot");
      }
      Serial.println(state_time_cnt-millis());
      while ((millis()-state_time_cnt) < 5000){
        long t = millis();
        update_PID();
        update_vel();
        write_vel();    // Debug
...
//    }
    if (analogRead(LSA_0) > 600|| analogRead(LSA_0) < 400)
    {

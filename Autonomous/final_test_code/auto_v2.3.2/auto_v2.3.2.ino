...
long max_base_val[17] =           { 200,  1700,   1000,      0,  100,    0,      0,     1000,     1450,   0,     0,    0,     0,     0,     0,     0,     100};
long acceleration_val[17] =       {   3,     4,     10,      0,    50,    0,    -11,    10,    11,   0,     -50,    0,    -6,     0,     0,     -6,   50};
long deacceleration_val[17] =     {   0,   -14,    -10,      0,    0,     0,    10,   -10,   -10,   0,      0,    0,     0,     0,     0,    6,      0};
int dis_2_slow[17] =              {   0, 15000,   6000,      0,    0,    0,   4000,  6000,  6000,   0,     0,    0,  3000,     0,     0, 16000,     0};
int time_2_slow[17] =             {   0,  3500,   1000,      0,    0,    0,    1000,  1500,  1000,   0,    0,    0,  1000,     0,     0,  2300,     0};
  ...
  ///////////////////// ALIGN WITH WALL ////////////////////////////////////////////
    ...
    if (state_9_flag == 0){
      if (millis()- state_time_cnt < time_2_align){
       ...
       junc_move_x(170);
        while(absolute(xEnc.read() - junc_pos_x) <  TZ2_dis_2_move){
        }
        stop_bot();
        delay(100);
        state_9_flag = 1;

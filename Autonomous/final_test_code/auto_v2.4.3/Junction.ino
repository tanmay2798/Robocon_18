void junction()
{
  if ((state != 4) && (state != 6) && (state != 9) && (state != 3) && (state != 10)&& (state != 12)&& (state != 15) && state != 30)
  {
    if (millis() - junc_time_cnt > 500)
    {
      ...
      else if ((millis() - state_time_cnt > 3200) && (state == 1 || state == 21 || state == 31))
      {
        junc = true;      
        junc_pos_x = xEnc.read();
        junc_pos_y = yEnc.read();
...
void check_line(int check_type){
  ...
  else if(state == 1 || state == 5 || state == 7 || state == 11 || state == 21 || state == 31)
  {
    if (check_type == 0){

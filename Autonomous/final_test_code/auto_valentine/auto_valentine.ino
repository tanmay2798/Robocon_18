...
int LED_rs1 = 6, LED_rs2 = 10, LED_rs3 = 11;
...
long min_base_val[40] =           {   0,     0,      0,      0,    0,    0,  -1450,   -840,    0,   0,  -200,    0,  -700,     0,     0,   -1400,   0};
long max_base_val[40] =           { 200,  2000,   1000,      0,  200,    0,      0,     1000,     1450,   0,     0,    0,     0,     0,     0,     0,     100};
long acceleration_val[40] =       {   3,     4,     10,      0,    15,    0,    -11,    10,    11,   0,     -15,    0,    -6,     0,     0,     -7,   50};
...
int time_2_slow[40] =             {   0,  3900,   1300,      0,    0,    0,    1000,  1500,  1000,   0,    0,    0,  1000,     0,     0,  2300,     0};
...
/////////////////////////// Ultrasonic //////////////////
float duration, cm;
int US_manual = 36, US_manual_reverse_trig = 48, manual_reverse_detect_pin = 46, US_manual_reverse_echo = 48, US_ball_detect = 46;

...
long min_base_val[40] =           {   0,     0,      0,      0,    0,    0,  -1450,   -840,     0,    0,  -500,    0,  -700,     0,     0, -1800,     0,    0,    400};
long max_base_val[40] =           { 400,  2000,   1000,      0,  500,    0,      0,   1000,  1450,    0,     0,    0,     0,     0,     0,  -400,   300,    0,   1800};
long acceleration_val[40] =       {   4,     4,     10,      0,   10,    0,     -11,     10,    11,    0,   -10,    0,   -6,     0,     0,    -8,    15,    0,      8};
long deacceleration_val[40] =     {   0,   -14,    -10,      0,   -1,    0,     10,    -10,   -10,    0,     1,    0,     0,     0,     0,     9,     0,    0,     -9};
int dis_2_slow[40] =              {   0, 15000,   6000,      0,    0,    0,   4000,   6000,  6000,    0,     0,    0,  3000,     0,     0, 16000,     0,    0,  16000};
int time_2_slow[40] =             {   0,  2900,   1300,      0,  700,    0,   1000,   1500,  1000,    0,   700,    0,  1000,     0,     0,  2300,     0,    0,   2300};
...
int manual_dis_min = 5, manual_dis_max = 100, manual_reverse_dis_min_1 = 1, manual_reverse_dis_max_1 = 50, ball_dis_min = 7, ball_dis_max = 18;
  ...
  else if (state == 16)
  {
    ...
    else if (absolute(analogRead(LSA_0) - target) > lsa_margin)
    {
      while(absolute(analogRead(LSA_0) - target) > lsa_margin){
        ...
        lsa_control = (target - aa)/10;
    Serial.print("\tLSA_0: ");
    Serial.print(aa);
        delay(1);
        Serial.print("LSA_control: ");
        Serial.println(lsa_control);

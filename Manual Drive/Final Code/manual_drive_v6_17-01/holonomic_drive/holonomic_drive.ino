...
int drive_kang_ramp_1 = 500;        // kang ramp
int drive_kang_ramp_2 = 500;        // kang ramp
int drive_kang_ramp_3 = 4300;        // kang ramp
  ...
  if (update_state){
    ...
    if (manual_ramp){
      ...
      if (vx == 0 && vy == 0 && ps_w == 0){
        ...
        drive_kang_ramp_1 = 10;
        drive_kang_ramp_2 = 10;
        drive_kang_ramp_3 = 100;
      }
      else{
         drive_kang_ramp_1 = 500;
         drive_kang_ramp_2 = 500;
         drive_kang_ramp_3 = 4500;
      }
    }
    ...
    //-----------------------------------------------------------
    if (kang_enable){
      drive_kangaroo_update(v1, v2, v3, false);        // Write value to kangaroo
    }

...
long drive_kang_ramp_2 = 490;        // kang ramp              | Change in loop also |
...
long speed_factor_initial = 30; // |-----Change in loop---|
long speed_factor_final = 30;   // |---------also---------|
...
void loop() {
  ...
  if (update_state){
    ...
    if (fine_control){                             // Reduce speed and ramp factor for fine manual control
      ...
      speed_factor_initial = 30;
      speed_factor_final = 30;
      manual_ramp = false;
    }
    if (manual_ramp){
      ...
      if (vx == 0 && vy == 0 && ps_w == 0){
        ...
        drive_kang_ramp_2 = 6000;
        drive_kang_ramp_3 = 14000;
      }

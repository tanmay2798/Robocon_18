...
int drive_kang_ramp_1 = 400;        // kang ramp
int drive_kang_ramp_2 = 400;        // kang ramp
int drive_kang_ramp_3 = 800;        // kang ramp
...
float x_vel_factor = 1.5;
float y_vel_factor = 1.5;
float cor_fact_1 = 1;
float cor_fact_2 = 1;
float cor_fact_3 = 1;
    ...
    if (manual_ramp){
      ...
      if (vx == 0 && vy == 0 && ps_w == 0){
        ...
        drive_kang_ramp_3 = 160;
         ...
         drive_kang_ramp_2 = 400;
         drive_kang_ramp_3 = 800;
      }
    }

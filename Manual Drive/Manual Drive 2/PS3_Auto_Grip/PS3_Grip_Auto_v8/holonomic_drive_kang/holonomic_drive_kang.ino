...
KangarooSerial K(Serial2);          // for back motors.
KangarooChannel K1(K, '1');
KangarooChannel K2(K, '2');
KangarooSerial M(Serial3);          // for front motor. 
...
void setup() {
  ...
  Serial3.begin(front_kangaroo_baud_rate);    // Sabertooth only
...
//drive_kangaroo_update(100, 100, 100, true);
